...
3. Настроить маршрутизацию между VRF, используя пограничный роутер FW.
...
interface Vxlan1
   ...
   vxlan vrf srv-10 vni 10100
   vxlan vrf srv-20 vni 10200
   bfd vtep evpn interval 500 min-rx 500 multiplier 3
   vxlan learn-restrict any
!
ip routing
ip routing vrf srv-10
...
! Last configuration change at 20:08:48 UTC Sat Feb 14 2026
!
version 15.4
service config
...
router bgp 65100
 ...
 neighbor leaf1 fall-over bfd
 neighbor leaf2 peer-group
 neighbor leaf2 remote-as 65102
 neighbor leaf2 fall-over bfd
...
Gateway of last resort:
 B E      0.0.0.0/0 [200/0] via 10.100.1.0, Vlan1100

 C        10.4.10.0/24 is directly connected, Vlan100
 C        10.100.1.0/31 is directly connected, Vlan1100
 B E      10.100.1.2/31 [200/0] via 10.100.1.0, Vlan1100
 B E      10.100.2.2/31 [200/0] via 10.100.1.0, Vlan1100
...
![ДЗ №8 L1](hw-08-check-for-failure.gif)
