...
## 1. План работ.
1. Скопировать стенд с домащнего задания №1.
2. Настроить OSPF на spine и leaf коммутаторах
3. Убедиться в наличии связаности между коммутаторами, с фиксацией результатов.
...
<details>
  <summary>база данных состояния каналов</summary>
